...
const AddStudentModal = ({
  onClose,
  onStudentAdded,
}: AddStudentModalProps): React.JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-bold text-neutral-900">Add Student</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full">
          ...
          <PrimaryButton onClick={handleSubmit} className="w-full">Save Student</PrimaryButton>
        </div>
      </div>
    </div>
  );
