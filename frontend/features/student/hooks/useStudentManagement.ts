...
export const useStudentManagement = () => {
	...
	const { createStudent, isPending: createPending } = useCreateStudentMutation();
	const { updateStudent, isPending: updatePending } = useUpdateStudentMutation();
	const { deleteStudent, isPending: deletePending } = useDeleteStudentMutation();
